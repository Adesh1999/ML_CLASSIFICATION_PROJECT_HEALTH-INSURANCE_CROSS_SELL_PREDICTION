...
• How The variable such as Age, Previously_insured,Annual_premium are afecting the target variable.

• We have to observe which that variable was highly imbalanced.So this issue will get solve by using Random or Sample resampling technique.

• where we have to apply feature scaling techniques to normalize our data to bring all features on the same scale and make it easier to process by ML algorithms.
